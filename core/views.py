        ...
        if user_sentence:
            ...
            if count_periods > 1:
                ...
                try:    
                    ...
                    pos_results = list(zip(tokenize_pos, predictions_pos))
                    ...
                    if structure_prediction == "Mivadi-drafitra":
                        ...
                        # Créer une liste de tuples (token, vos) pour l'affichage avec flèches
                        vos_results = list(zip(tokenize_words_md(user_sentence), predictions_vos))
                    else:
                        tokenize_vos = tokenize_words_td(user_sentence)
                        # Créer une liste de tuples (token, vos) pour l'affichage avec flèches
                        vos_results = list(zip(tokenize_words_td(user_sentence), predictions_vos))
                    ...
                    context = {
                        ...
                        'vos_results': vos_results,  # Nouvelle variable pour l'affichage VOS
                        'fki': fki, 
                        'predictions_summary': predictions_summary, 
                        'structure_prediction': structure_prediction,
                        'tokenize_vos': tokenize_vos,
